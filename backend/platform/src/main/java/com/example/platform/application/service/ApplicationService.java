    ...
    public List<ApplicantDto> getApplicantsForJob(Long jobId, String recruiterEmail) {
        ...
        return applicationRepository.findByJobId(jobId).stream().map(app -> ApplicantDto.builder()
            ...
            .studentUserId(app.getStudent().getUser().getId())
                ...
                .phone(app.getStudent().getPhone())
                .location(app.getStudent().getLocation())
                .headline(app.getStudent().getHeadline())
                .about(app.getStudent().getAbout())
                .university(app.getStudent().getUniversity())
                .degree(app.getStudent().getDegree())
                .graduationYear(app.getStudent().getGraduationYear())
                .specialization(app.getStudent().getSpecialization())
                .currentSemester(app.getStudent().getCurrentSemester())
                .courseType(app.getStudent().getCourseType())
                .cgpa(app.getStudent().getCgpa())
                .skills(app.getStudent().getSkills())
                .experience(app.getStudent().getExperience())
                .projects(app.getStudent().getProjects())
                .certifications(app.getStudent().getCertifications())
                .achievements(app.getStudent().getAchievements())
                .preferredRoles(app.getStudent().getPreferredRoles())
                .languages(app.getStudent().getLanguages())
                .links(app.getStudent().getLinks())

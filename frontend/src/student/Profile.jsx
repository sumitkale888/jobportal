                        ...
                        <form onSubmit={handleSubmit}>
                            ...
                            <div className="grid grid-cols-1 md:grid-cols-2 gap-6 mb-6">
                                ...
                                <div>
                                    ...
                                    <input type="number" name="cgpa" value={formData.cgpa} onChange={handleChange}
                                        className="w-full p-3 border rounded-lg" placeholder="9.5" />
                                </div>
                            </div>
                            ...
                            <div className="mb-6">
                                <label className="block text-sm font-medium text-gray-700 mb-2">
                                    <Code className="inline w-4 h-4 mr-1"/> Skills (comma separated)
                                </label>
                                <textarea name="skills" value={formData.skills} onChange={handleChange}
                                    className="w-full p-3 border rounded-lg focus:ring-2 focus:ring-blue-500"
                                    placeholder="Java, React, Spring Boot..." required />
                            </div>
                            ...
                            <div className="mb-6">
                                ...
                                <textarea name="experience" value={formData.experience} onChange={handleChange}
                                    className="w-full p-3 border rounded-lg" placeholder="Briefly describe your internships or projects..." />
                            </div>
                            ...
                            <div className="mb-8">
                                ...
                                <input type="text" name="resumeUrl" value={formData.resumeUrl} onChange={handleChange}
                                    className="w-full p-3 border rounded-lg" placeholder="https://drive.google.com/..." />
                            </div>
